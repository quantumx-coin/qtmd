...
// installService attempts to install the htnd service. Typically this should
...
// removeService attempts to uninstall the htnd service. Typically this should
...
// startService attempts to Start the htnd service.
