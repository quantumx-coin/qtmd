...
func (x *HoosatdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "HoosatdMessage_Addresses is nil")
	}
...
func (x *HoosatdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
