...
// hoosat Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a hoosat
// Addresses message.
...
// NewMsgAddresses returns a new hoosat Addresses message that conforms to the
