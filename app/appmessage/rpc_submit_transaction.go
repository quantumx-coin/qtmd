...
// RPCTransaction is a htnd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a htnd transaction input representation
...
// RPCScriptPublicKey is a htnd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a htnd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a htnd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a htnd utxo entry representation meant to be used
// over RPC
