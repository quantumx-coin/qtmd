...
// MsgRequestNextHeaders implements the Message interface and represents a hoosat
...
// NewMsgRequestNextHeaders returns a new hoosat RequestNextHeaders message that conforms to the
// Message interface.
