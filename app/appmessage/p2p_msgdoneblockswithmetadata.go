...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a hoosat
...
// NewMsgDoneBlocksWithTrustedData returns a new hoosat DoneBlocksWithTrustedData message that conforms to the
// Message interface.
