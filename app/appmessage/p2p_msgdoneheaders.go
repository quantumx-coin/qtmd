...
// MsgDoneHeaders implements the Message interface and represents a hoosat
...
// NewMsgDoneHeaders returns a new hoosat DoneIBDBlocks message that conforms to the
// Message interface.
