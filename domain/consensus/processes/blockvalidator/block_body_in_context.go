...
import (
	...
	"github.com/quantumx-coin/qtmd/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/hoosatnet/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
