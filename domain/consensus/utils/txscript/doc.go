...
hoosat transaction scripts.

# Script Overview

Hoosat transaction scripts are written in a stack-base, FORTH-like language.

The hoosat script language consists of a number of opcodes which fall into
...
Typical hoosat scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend hoosat.
